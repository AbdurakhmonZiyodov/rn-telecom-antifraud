...
exports.TelecomAFError = void 0;
exports.isRecoverableAccountError = isRecoverableAccountError;
exports.toTelecomAFError = toTelecomAFError;
// any other SDK/native error

class TelecomAFError extends Error {
 ...
 */
exports.TelecomAFError = TelecomAFError;
function toTelecomAFError(error) {
...
function isRecoverableAccountError(error) {
